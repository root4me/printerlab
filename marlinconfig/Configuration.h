...
#define STRING_CONFIG_H_AUTHOR "(harish, printerlab config)" // Who made the changes.
...
// Displayed in the LCD "Ready" message
 #define CUSTOM_MACHINE_NAME "printerlab"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Custom setting based on PID auto tuning M303 E0 S200 C8
  #define  DEFAULT_Kp 16.60
  #define  DEFAULT_Ki 0.83
  #define  DEFAULT_Kd 82.85
...
//#define PID_BED_DEBUG // Sends debug data to the serial port.
  ...
  //custom values after runnig "M303 E-1 C8 S90"
  #define  DEFAULT_bedKp 398.91
  #define  DEFAULT_bedKi 27.05
  #define  DEFAULT_bedKd 1470.59
...
// lead screw (z axis) steps_per_mm = (motor_steps_per_rev * driver_microstep) / thread_pitch
// NEMA 17 motor with M5 threaded rod for z axis
// ((360 * 1.8) * 16)) / 0.8

// Direct drive extruder: e_steps_per_mm = (motor_steps_per_rev * driver_microstep) / (hob_effective_diameter * pi)
